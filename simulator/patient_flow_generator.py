...
EVENTHUBS_NAMESPACE = "<NAMESPACE>"  # ONLY the namespace, no domain
EVENT_HUB_NAME = "<EVENTHUBNAME>"
SAS_KEY_NAME = "<SASKEYNAME>"
SAS_KEY = "<SASKEY>"  # raw key only

producer = KafkaProducer(
    bootstrap_servers=f"{EVENTHUBS_NAMESPACE}.servicebus.windows.net:9093",  # clean URL
